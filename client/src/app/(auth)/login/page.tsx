  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ width: "100%", maxWidth: 380, background: "var(--bg2)", border: "1px solid var(--border)", borderRadius: 20, padding: "36px 32px" }}>
        ...
        <h1 style={{ fontSize: 20, fontWeight: 700, textAlign: "center", marginBottom: 6 }}>Welcome back</h1>
        <p style={{ fontSize: 13, color: "var(--text2)", textAlign: "center", marginBottom: 24 }}>Sign in to your startup workspace</p>

        {/* OAuth */}
        <a href={`${API_URL}/auth/google`} style={oauthStyle}>
          <GoogleIcon /> Continue with Google
        </a>
        <a href={`${API_URL}/auth/github`} style={oauthStyle}>
...
const oauthStyle: React.CSSProperties = {
  ...
  textDecoration: "none", marginBottom: 10, cursor: "pointer", transition: "all .15s",
};
const labelStyle: React.CSSProperties = { display: "block", fontSize: 12, color: "var(--text2)", marginBottom: 6 };
...
const primaryBtnStyle: React.CSSProperties = {
  ...
  padding: "11px 0", fontSize: 14, fontWeight: 500, color: "#fff", cursor: "pointer",
};
