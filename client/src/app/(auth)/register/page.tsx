  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ width: "100%", maxWidth: 380, background: "var(--bg2)", border: "1px solid var(--border)", borderRadius: 20, padding: "36px 32px", animation: "fadeIn .2s ease-out" }}>
        ...
        <h1 style={{ fontSize: 22, fontWeight: 700, textAlign: "center", marginBottom: 6 }}>Create your account</h1>
        ...
        {/* Divider */}
        <div style={{ display: "flex", alignItems: "center", gap: 12, margin: "4px 0 16px", color: "var(--text3)", fontSize: 12 }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <div>
            ...
            <input type="text" className="input" placeholder="Alex Rahman" required minLength={2}
